    ...
    constructor(mergedConfig, messageInterface, extras){
        ...
        let socketRegister = () => {
            ...
            setTimeout(() =>function() {
                ...
                this.socket.emit("DUMMYEMITTTTTTTTTTTTTTTTTT", {
        ...
        this.socket.on("disconnect", async () => {
            ...
            this.registered = false;
            this.messageInterface('/silent-command remote.call("trainTeleports", "setWorldId","0") game.print("Lost connection to master!")');
        });

        this.socket.on("trainTeleporter_registered", async () => {
